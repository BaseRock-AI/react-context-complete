...
import { CustomButton } from '../../../src/components/custom-button/custom-button.component.jsx';
...
describe('CustomButton', () => {
  ...
  it('passes other props to the button element', () => {
    ...
    // Remove the expectation for the 'type' attribute as it's not set in the component
  });
});