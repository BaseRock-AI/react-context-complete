...
import { setCurrentUser } from '../../../src/redux/user/user.actions.js';

// Mock UserActionTypes
const UserActionTypes = {
  SET_CURRENT_USER: 'SET_CURRENT_USER'
};

jest.unstable_mockModule('../../../src/redux/user/user.types', () => ({
  UserActionTypes
}));
...
describe('setCurrentUser', () => {
  ...
  it('should handle undefined user input', () => {
    const action = setCurrentUser(undefined);
    expect(action.type).toBe(UserActionTypes.SET_CURRENT_USER);
