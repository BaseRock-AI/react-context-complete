...
jest.mock('../../../src/components/sign-in/sign-in.component', () => {
  return function DummySignIn() {
    return <div data-testid="mock-sign-in">SignIn Component</div>;
  };
});

jest.mock('../../../src/components/sign-up/sign-up.component', () => {
  return function DummySignUp() {
    return <div data-testid="mock-sign-up">SignUp Component</div>;
  };
});
...
describe('SignInAndSignUpPage', () => {
  ...
  it('renders SignIn and SignUp components', () => {
    render(<SignInAndSignUpPage />);
